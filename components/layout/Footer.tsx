  ...
  return (
    <footer className="bg-white border-t border-gray-100 pt-12 sm:pt-16 lg:pt-20 pb-6 sm:pb-10">
      <div className="container mx-auto px-4 sm:px-6">
        {/* Custom Grid Layout */}
        <div className="mb-10 sm:mb-12 lg:mb-16 space-y-8 sm:space-y-10">
        ...
        <div className="flex flex-col items-start text-right">
          ...
          <div className="flex flex-col sm:flex-row gap-2 sm:gap-3 mt-2">
            <div className="flex-1 bg-black text-white px-3 sm:px-4 py-2 rounded-xl flex items-center gap-2 cursor-pointer hover:bg-gray-900 transition shadow-lg justify-start">
